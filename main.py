...
class LogInScreen(Screen):
    def __init__(self, **kwargs):
        ...
        logo_layout = BoxLayout(orientation="horizontal", size_hint=(1.0, 0.2))
        logo = Image(
            source="jhs.png", size_hint=(1.0, 1.0)
        ...
        title_label = Label(
            text="Welcome to QuizApp!", font_size="30sp", color=(1, 1, 1, 1)
        )
        ...
        login_button = Button(
            ...
            height="40dp",
            background_normal="",
            background_color=(0.1, 0.4, 0.5, 0.7),
            color=(1, 1, 1, 1),
        )
    ...
    def show_popup(self):
        ...
        ok_button = Button(
            text="OK", size_hint_y=None, height="40dp", on_press=self.dismiss_popup
        )
        ...
        popup = Popup(
            title="Warning", content=content, size_hint=(None, None), size=(300, 200)
        )
        popup.open()
...
class QuizScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(
            4
        ):  # Assuming each question has 4 options, adjust this number accordingly
            button = Button(
                text="",
    ...
    def save_answers(self):
        ...
        with open(filename, "w") as file:
            ...
            for i, question_data in enumerate(self.questions):
                selected_answer = (
                    self.selected_answers[i]
                    if i < len(self.selected_answers)
                    else "No answer"
                )
...
class ResultScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.save_button = Button(
            text="Save Answers",
            on_press=self.save_answers_to_file,
            size_hint_y=None,
            height="40dp",
            background_normal="",
            background_color=(0.1, 0.4, 0.5, 0.7),
        ...
        layout.add_widget(
            Label(text="Congratulations! Quiz is completed.",size_hint_y=None,halign="center",
                valign="middle",
                markup=True,
                text_size=(800, None),
            )
